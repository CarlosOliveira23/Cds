...
-----------------------------------------------------------------------------------------------------------------------------------------
Kaduzera = {}
Tunnel.bindInterface("arena", Kaduzera)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Players = {}
...
-- CHECKENTER
-----------------------------------------------------------------------------------------------------------------------------------------
function Kaduzera.CheckEnter(Route, Number)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		if Arenas[Number] then
			if vRP.Request(source,"Prosseguir para a <b>Arena</b> pagando <b>$" .. parseFormat(Arenas[Number]["Price"]) .. "</b> Dólares?") then
