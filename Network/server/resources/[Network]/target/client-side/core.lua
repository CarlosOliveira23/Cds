...
CreateThread(function()
	...
	AddCircleZone("WorkBus01",vec3(453.47,-602.34,28.59),0.5,{
		name = "WorkBus01",
		heading = 3374176
	},{
		Distance = 1.0,
	...
	AddCircleZone("Desmanche",vec3(103.6,-1084.56,29.18),0.9,{
     	name = "Desmanche",
     	heading = 155.91
 	},{
     	shop = "Santos",
	...
	AddBoxZone("Medicplan01",vec3(300.93,-601.99,43.39),0.25,0.25,{
		name = "Medicplan01",
		heading = 3374176,
	},{
		Distance = 2.0,
	...
	AddCircleZone("Lenhador01",vec3(-841.42,5401.52,34.61),0.5,{
		name = "Lenhador01",
		heading = 3374176
	},{
		Distance = 1.0,
		options = {
			{
				event = "works:lenhador",
				label = "Traje Lenhador",
				tunnel = "server"
			},{
				event = "shops:Lenhador",
				label = "Vender Madeiras",
				tunnel = "client"
			}
		}
	})

	AddCircleZone("Colheita01",vec3(2416.38,4993.82,46.22),0.5,{
		name = "Colheita01",
		heading = 3374176
	},{
		Distance = 1.0,
		options = {
			{
				event = "works:colheita",
				label = "Traje Colheita",
				tunnel = "server"
			},{
	...
	AddCircleZone("Faxina01",vec3(1121.77,-645.98,56.82),0.5,{
		name = "Faxina01",
		heading = 3374176
	},{
		Distance = 1.0,
		options = {
			{
				event = "works:faxina",
				label = "Traje Faxineiro",
				tunnel = "server"
			}
		}
	})

	AddCircleZone("Taxista01",vec3(895.22,-179.22,74.7),0.5,{
		name = "Taxista01",
		heading = 3374176
	},{
		Distance = 1.0,
	...
	AddCircleZone("Lixeiro01",vec3(85.28,-1550.61,29.59),0.5,{
		name = "Lixeiro01",
		heading = 3374176
	},{
		Distance = 1.0,
					...
					elseif IsPedAPlayer(Entity) then
						if #(Coords - entCoords) <= 1.0 then
							...
							if LocalPlayer["state"]["Police"] then
								...
								Menu[#Menu + 1] = { event = "police:Apreender", label = "Apreender Itens", tunnel = "police" }
