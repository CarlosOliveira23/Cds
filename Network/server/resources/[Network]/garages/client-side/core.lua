...
local Garages = {
	...
	["69"] = { x = -939.36, y = -2114.65, z = 9.77,
		["1"] = { -940.69,-2108.13,8.98,42.52 },
		["2"] = { -938.72,-2105.02,8.98,45.36 },
		["3"] = { -936.06,-2102.96,8.98,45.36 },
		["4"] = { -933.56,-2100.46,8.98,45.36 },
		["5"] = { -931.27,-2098.04,8.98,45.36 },
		["6"] = { -928.87,-2095.46,8.98,45.36 }
	},
	["70"] = { x = 850.48, y = -1382.51, z = 26.3,
		["1"] = { 864.99,-1377.32,25.81,39.69 },
		["2"] = { 862.21,-1382.53,25.83,36.86 },
		["3"] = { 859.48,-1388.04,25.85,36.86 },
		["4"] = { 857.0,-1394.22,25.83,39.69 },
		["5"] = { 854.17,-1398.67,25.81,36.86 }
	},
	...
	["147"] = { x = -284.65, y = 6146.01, z = 31.49,
		["1"] = { -283.92,6138.55,31.59,133.23 }
	},
	...
	["150"] = { x = 1695.55, y = 4787.69, z = 42.01,
	...
	["152"] = { x = 842.46, y = -994.6, z = 27.9,
		["1"] = { 842.55,-998.86,27.89,90.71 }
	}
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHICLEMODS
...
function Kaduzera.SearchBlip(Coords)
	...
	SetBlipHighDetail(Searched,true)
...
function Kaduzera.StartHotwired()
	...
	if LoadAnim(Dict) then
		TaskPlayAnim(PlayerPedId(),Dict,Anim,4.0,4.0,-1,49,5.0,0,0,0)
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- STOPHOTWIRED
			...
			if not IsPedInAnyVehicle(Ped) then
				...
				for Number,v in pairs(Garages) do
					...
					if Distance <= 15 then
						...
						if Distance <= 1.25 and IsControlJustPressed(1,38) and not exports["hud"]:Wanted() and not LocalPlayer["state"]["Target"] then
							...
							if Vehicles then
								...
								if parseInt(#Vehicles) > 0 then
									for _,v in pairs(Vehicles) do
										if v["Mode"] == "dismantle" then
											exports["dynamic"]:AddButton("Pegar","Clique para pega-lo na garagem.","garages:Spawn",v["Model"].."-"..Number,v["Model"],true)

											exports["dynamic"]:AddButton("Validade","Vencimento em <yellow>"..v["Dismantle"].."</yellow>.","","",v["Model"],false)
										else
											exports["dynamic"]:AddButton("Pegar","Clique para pega-lo na garagem.","garages:Spawn",v["Model"].."-"..Number,v["Model"],true)
											...
											if v["Tax"] then
												exports["dynamic"]:AddButton("Taxas","Próxima em <yellow>"..v["Tax"].."</yellow>.","garages:Tax",v["Model"],v["Model"],true)
											end

											if v["Rental"] then
												exports["dynamic"]:AddButton("Aluguel","Vencimento em <yellow>"..v["Rental"].."</yellow>.","","",v["Model"],false)
											end
										end
