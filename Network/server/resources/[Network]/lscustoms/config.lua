vehicleCustomisationPrices = {
	cosmetics = 1250,
	respray = 1250,
	engines = { 999999, 8000, 12000, 18000, 22000, 25000 },
	brakes = { 999999, 10000, 14000, 18000, 22000, 25000 },
	transmission = { 999999, 8000, 12000, 18000, 22000, 28000 },
	suspension = { 999999, 10000, 15000, 18000, 22000, 25000 },
	shield = { 999999, 15000, 20000, 25000, 30000, 35000 },
	turbo = 7250,
	wheels = 1250,
	customwheels = 1250,
	wheelsmoke = 775,
